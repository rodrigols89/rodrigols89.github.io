                    ...
                    <div className="col-lg-12">
                        ...
                        <p>
                            <ul>
                                ...
                                <li>Com formação em <strong>Análise e Desenvolvimento de Sistemas</strong>, atualmente estou especializando em <strong>Ciência de Dados</strong> e <strong>Segurança da Informação</strong> com o objetivo de desenvolver software inteligente para cibersegurança.</li>
                            </ul>
                        </p>
                    </div>
                </div>
